...
# =========== CẤU HÌNH ============
GOOGLE_SHEET_URL = 'https://docs.google.com/spreadsheets/d/1x982zCBXltNhsIlvFpp516Pt1F7YGDPcJ9oUzKbwxtY/edit?pli=1&gid=754183493#gid=754183493'
CREDENTIALS_FILE = 'mybot-468103-2c8133fa8479.json'
TELEGRAM_BOT_TOKEN = '7745960830:AAF1z1ZQIvL-fyXf-jAHD69crNuWQj9dHsU'
TELEGRAM_CHAT_ID = -4901592432
IMAGE_FILE = 'image_sheet2.png'
...
sheet = client.open_by_url(GOOGLE_SHEET_URL).worksheet("ER-HN02-Ca 2")
...
async def send_photo_to_telegram():
    ...
    with open(IMAGE_FILE, 'rb') as f:
        await bot.send_photo(chat_id=TELEGRAM_CHAT_ID, photo=f, caption="📊 Báo cáo Kho HN02 - CA 2")
